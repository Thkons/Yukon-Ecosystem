 ...
 * @author Thanasis
 */
public class Medical_SecretaryController implements Initializable {
@FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        button_login.setOnAction(new EventHandler<ActionEvent>() {
          ...
          {
          DBUtils.logInUser1(event, tf_username.getText(), tf_password.getText());
          }
      });
    ...
    void setUserInformation(String username, String ISA) {
